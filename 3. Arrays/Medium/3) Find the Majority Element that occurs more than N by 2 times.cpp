...
// Reason: For every element of the array the inner loop runs 
// for N times. And there are N elements in the array. 
// So, the total time complexity is O(N2). 
...
// Insertion in the map takes logN time. 
// And we are doing it for N elements. 
